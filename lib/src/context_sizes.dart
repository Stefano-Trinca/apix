...
extension Sizes on BuildContext {
  ...
  EdgeInsets? get _maybeSystemGestureInsets => MediaQuery.maybeSystemGestureInsetsOf(this);
  ...
  double? get _maybeDevicePixelRatio => MediaQuery.maybeDevicePixelRatioOf(this);
